 ...
 */
public class ZonaEditor extends Editor<Zona> {

    private static final Logger log = LoggerFactory.getLogger(ZonaEditor.class);
    
    private Aplicacion app;
    private Zona zona;

    public ZonaEditor(Aplicacion app, MonitorListener monitor) {
        initComponents();
    ...
    @Override
    public void mostrarItem(Zona item) throws AppException {
        zona = item;
        mostrar();
        setActivo(true);
    }
    ...
    @Override
    public void borrarItem(Zona item) throws AppException {
        zona = item;
        mostrar();
        setActivo(false);
    }
    ...
    public void mostrar() {
        jtfNombre.setText(zona.getNombre());
        jtaDescripcion.setText(zona.getDescripcion());
    }

    @Override
    public Zona getItem() throws AppException {
        zona.setNombre(jtfNombre.getText());
        zona.setDescripcion(jtaDescripcion.getText());
        return zona;
    }
