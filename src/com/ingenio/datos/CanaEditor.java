 ...
 */
public class CanaEditor extends Editor<Cana> {

    private static final Logger log = LoggerFactory.getLogger(CanaEditor.class);
    
    private Aplicacion app;
    private Cana cana;

    public CanaEditor(Aplicacion app, MonitorListener monitor) {
        initComponents();
    ...
    @Override
    public void mostrarItem(Cana item) throws AppException {
        cana = item;
        mostrar();
        setActivo(true);
    }
    ...
    @Override
    public void borrarItem(Cana item) throws AppException {
        cana = item;
        mostrar();
        setActivo(false);
    }
    ...
    public void mostrar() {
        jtfNombre.setText(cana.getNombre());
        jtaDescripcion.setText(cana.getDescripcion());
    }

    @Override
    public Cana getItem() throws AppException {
        cana.setNombre(jtfNombre.getText());
        cana.setDescripcion(jtaDescripcion.getText());
        return cana;
    }
