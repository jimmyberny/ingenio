...
/**
 */
public class ZafraBuscador extends Buscador<Zafra> {

    private static final Logger log = LoggerFactory.getLogger(ZafraBuscador.class);

    private OrigenGeneral oGeneral;

    public ZafraBuscador(Frame parent, boolean modal) {
        super(parent, modal);
    }

    public ZafraBuscador(Dialog parent, boolean modal) {
        super(parent, modal);
    }

    public static ZafraBuscador mostrar(Component padre, Aplicacion app) {
        ZafraBuscador ab;
        Window mw = SwingUtilities.getWindowAncestor(padre);
        if (mw instanceof Frame) {
            ab = new ZafraBuscador((Frame) mw, true);
        } else {
            ab = new ZafraBuscador((Dialog) mw, true);
        }
        ab.initComponents();
        ab.init(app);
    ...
    private void initComponents() {
        ...
        jlZafras = new javax.swing.JList();
        ...
        jlZafras.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jspItems.setViewportView(jlZafras);
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        try {
            modelo.setList(oGeneral.listarZafras(jtfNombre.getText()));
            log.info("Modelo{}", modelo.getSize());
        } catch (AppException ex) {
            new AppMensaje("No se pudo consultar las zafras", ex).mostrar(this);
        }
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        try {
            aceptar(jlZafras.getSelectedIndex());
        } catch (AppException ex) {
    ...
    private javax.swing.JList jlZafras;
