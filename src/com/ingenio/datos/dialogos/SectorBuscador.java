...
/**
 */
public class SectorBuscador extends Buscador<Sector> {

    private static final Logger log = LoggerFactory.getLogger(SectorBuscador.class);

    private OrigenGeneral oGeneral;

    public SectorBuscador(Frame parent, boolean modal) {
        super(parent, modal);
    }

    public SectorBuscador(Dialog parent, boolean modal) {
        super(parent, modal);
    }

    public static SectorBuscador mostrar(Component padre, Aplicacion app) {
        SectorBuscador ab;
        Window mw = SwingUtilities.getWindowAncestor(padre);
        if (mw instanceof Frame) {
            ab = new SectorBuscador((Frame) mw, true);
        } else {
            ab = new SectorBuscador((Dialog) mw, true);
        }
        ab.initComponents();
        ab.init(app);
    ...
    private void initComponents() {
        ...
        jlSectores = new javax.swing.JList();
        ...
        jlSectores.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jspItems.setViewportView(jlSectores);
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        try {
            modelo.setList(oGeneral.listarSectores(jtfNombre.getText()));
        } catch (AppException ex) {
            new AppMensaje("No se pudo consultar los sectores", ex).mostrar(this);
        }
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        try {
            aceptar(jlSectores.getSelectedIndex());
        } catch (AppException ex) {
    ...
    private javax.swing.JList jlSectores;
