...
/**
 */
public class OrganizacionBuscador extends Buscador<Organizacion> {

    private static final Logger log = LoggerFactory.getLogger(OrganizacionBuscador.class);

    private OrigenGeneral oGeneral;

    public OrganizacionBuscador(Frame parent, boolean modal) {
        super(parent, modal);
    }

    public OrganizacionBuscador(Dialog parent, boolean modal) {
        super(parent, modal);
    }

    public static OrganizacionBuscador mostrar(Component padre, Aplicacion app) {
        OrganizacionBuscador ab;
        Window mw = SwingUtilities.getWindowAncestor(padre);
        if (mw instanceof Frame) {
            ab = new OrganizacionBuscador((Frame) mw, true);
        } else {
            ab = new OrganizacionBuscador((Dialog) mw, true);
        }
        ab.initComponents();
        ab.init(app);
    ...
    private void init(Aplicacion app) {
        ...
        jlOrganizaciones.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        jlOrganizaciones = new javax.swing.JList();
        ...
        jlOrganizaciones.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jspItems.setViewportView(jlOrganizaciones);
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        try {
            modelo.setList(oGeneral.listarOrganizaciones(jtfNombre.getText()));
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        try {
            aceptar(jlOrganizaciones.getSelectedIndex());
        } catch (AppException ex) {
    ...
    private javax.swing.JList jlOrganizaciones;
