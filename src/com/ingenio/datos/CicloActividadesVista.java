 ...
 */
public class CicloActividadesVista extends CatalogoPanel<ActividadesPorCiclo> {
    ...
    protected Editor<ActividadesPorCiclo> getEditor() {
        return new CicloActividadesEditor(app, monitor, zafraActual);
    }
